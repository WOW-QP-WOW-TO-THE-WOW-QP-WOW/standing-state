...
const ESSAYS = [
  ...
  {
    id: '003',
    title: 'Identity, Law, and the Messiah',
    mediumTitle: 'Architecture of Interpretation',
    mediumUrl: '',
    axis1: 'PLT-COORD',
    axis2: 'VOL-CROSS',
    axis3: 'REG-SPIRIT',
    flag: 'A',
    note: 'Identity stabilizes through lawful recognition. The Father establishes source, the law expresses structure, the Messiah mediates truth, the Sabbath creates stillness, the soul recognizes itself through alignment.',
