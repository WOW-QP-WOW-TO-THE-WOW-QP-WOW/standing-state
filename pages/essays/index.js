...
const ESSAYS = [
  ...
  // M012–M033 exist in canonical corpus but are not yet present in
  // this v2 repo state. This insertion preserves forward registration
  // without implying sequential completeness. IDs remain canonical:
  // M034 stays M034. Backfill of M012–M033 can occur later without
  // conflict.
  // ─────────────────────────────────────────────────────────────────
  {
    id: 'M034',
