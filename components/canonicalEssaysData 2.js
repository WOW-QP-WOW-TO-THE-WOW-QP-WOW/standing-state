...
export const CANONICAL_ESSAYS = [
  ...
  {
    id: 'm035',
    slug: 'the-bull-was-never-the-animal',
    number: 'Essay M035',
    title: 'The Bull Was Never the Animal',
    subtitle: 'Identity invariant under excitation; enlightenment as collapse of state-to-identity gain.',
    axis1: 'PLT-COORD',
    axis2: 'VOL-SS',
    axis3: 'REG-MIXED',
    equation: '∂I/∂S = 0     G = 0',
    thesis: 'The classical image of the bull is re-read as a control problem: not an animal to be found, but the invariant coordinate obscured by state-to-identity coupling. The Standing State begins when environmental excitation loses write-access to identity.',
    body: [
      {
        paragraph: 'Let S(t) denote environmental state and I(t) the claimed identity state. In the mirrored condition, identity is coupled to state through gain G, so marketplace noise, praise, criticism, and pressure can write into self-definition. The lost bull is not absence of identity, but identity embedded in fluctuation.'
      },
      {
        paragraph: 'The control form can be written as e(t) = I(t) - I₀, with restoring strength α, environmental coupling G·S(t), and bounded biological noise η(t). Input-to-state stability can damp this reactivity, but damping is not sovereignty. Rank-0 begins at the Hard Cut: ∂I/∂S = 0. Identity no longer borrows stability from conditions.'
      },
      {
        paragraph: 'This is not suppression, retreat, or dissociation. State may continue, biology may oscillate, and load may remain active, yet identity stays fixed. The final stage is invariance under excitation: the marketplace continues, and identity does not drift.'
      }
    ],
